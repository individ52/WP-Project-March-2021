            ...
            <form action="#" class="order_form">
                <div class="order_form_wrapper">
                    ...
                    <div class="order_cardselected">
                        <img src="img/catalog/carcaver.png" alt="orderimg" class="orderimg" id="orderimgID">
                        <p class="catalog_items_item_desc">Серый-Серый</p>
                        <p class="catalog_items_item_price">135 eur</p>
                    </div>
                </div>
                <div class="order_form_check">
                    <input type="checkbox" name="install" id="installID" class="order_form_check_checkbox">
                    <label for="instal">Установка <span>чехлов</span> 70 EUR</label>
                    <a href="#" class="order_form_check_link">?</a>
                </div>
